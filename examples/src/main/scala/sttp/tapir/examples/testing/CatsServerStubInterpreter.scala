...
//> using dep com.softwaremill.sttp.tapir::tapir-cats-effect:1.13.18
//> using dep com.softwaremill.sttp.tapir::tapir-sttp-stub4-server:1.13.18
//> using dep com.softwaremill.sttp.tapir::tapir-cats:1.13.18
