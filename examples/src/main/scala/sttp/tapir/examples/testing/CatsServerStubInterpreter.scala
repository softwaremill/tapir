...
//> using dep com.softwaremill.sttp.tapir::tapir-cats-effect:1.11.38
//> using dep com.softwaremill.sttp.tapir::tapir-sttp-stub4-server:1.11.38
//> using dep com.softwaremill.sttp.tapir::tapir-cats:1.11.38
