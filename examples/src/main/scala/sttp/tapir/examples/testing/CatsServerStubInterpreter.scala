...
//> using dep com.softwaremill.sttp.tapir::tapir-cats-effect:1.11.12
//> using dep com.softwaremill.sttp.tapir::tapir-sttp-stub-server:1.11.12
//> using dep com.softwaremill.sttp.tapir::tapir-cats:1.11.12
