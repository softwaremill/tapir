...
// scala 3.6.+ is required for tapir-iron:1.13.4
//> using scala 3.6.4

//> using dep com.softwaremill.sttp.tapir::tapir-core:1.13.4
//> using dep com.softwaremill.sttp.tapir::tapir-netty-server-cats:1.13.4
//> using dep com.softwaremill.sttp.tapir::tapir-json-circe:1.13.4
//> using dep com.softwaremill.sttp.tapir::tapir-iron:1.13.4
