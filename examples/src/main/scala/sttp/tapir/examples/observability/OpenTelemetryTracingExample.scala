...
//> using dep com.softwaremill.sttp.tapir::tapir-opentelemetry-tracing:1.13.17
//> using dep io.opentelemetry:opentelemetry-exporter-otlp:1.61.0
//> using dep io.opentelemetry:opentelemetry-sdk-extension-autoconfigure:1.61.0
