...
//> using dep com.softwaremill.sttp.tapir::tapir-opentelemetry-tracing:1.13.12
//> using dep io.opentelemetry:opentelemetry-exporter-otlp:1.60.1
//> using dep io.opentelemetry:opentelemetry-sdk-extension-autoconfigure:1.60.1
