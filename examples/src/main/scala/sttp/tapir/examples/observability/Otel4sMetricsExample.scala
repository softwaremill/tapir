...
//> using dep com.softwaremill.sttp.tapir::tapir-netty-server-cats:1.13.17
//> using dep com.softwaremill.sttp.tapir::tapir-json-circe:1.13.17
//> using dep com.softwaremill.sttp.tapir::tapir-otel4s-metrics:1.13.17
//> using dep "org.typelevel::otel4s-oteljava:0.16.0"
