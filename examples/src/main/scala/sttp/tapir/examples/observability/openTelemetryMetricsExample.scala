...
//> using dep com.softwaremill.sttp.tapir::tapir-netty-server:1.11.48
//> using dep com.softwaremill.sttp.tapir::tapir-json-circe:1.11.48
//> using dep com.softwaremill.sttp.tapir::tapir-opentelemetry-metrics:1.11.48
