...
//> using dep com.softwaremill.sttp.tapir::tapir-jsoniter-scala:1.13.23
//> using dep com.softwaremill.sttp.tapir::tapir-netty-server-sync:1.13.23
//> using dep com.softwaremill.sttp.tapir::tapir-swagger-ui-bundle:1.13.23
