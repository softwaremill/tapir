...
//> using dep com.softwaremill.sttp.tapir::tapir-http4s-server-zio:1.11.34
//> using dep com.softwaremill.sttp.tapir::tapir-swagger-ui-bundle:1.11.34
//> using dep com.softwaremill.sttp.tapir::tapir-zio:1.11.34
