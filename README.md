...
```scala
"com.softwaremill.tapir" %% "core" % "0.0.2"
```
...
```scala
"com.softwaremill.tapir" %% "json-circe" % "0.0.2"
```
...
```scala
"com.softwaremill.tapir" %% "akka-http-server" % "0.0.2"
```
...
```scala
"com.softwaremill.tapir" %% "sttp-client" % "0.0.2"
```
...
```scala
"com.softwaremill.tapir" %% "openapi-docs" % "0.0.2"
"com.softwaremill.tapir" %% "openapi-circe-yaml" % "0.0.2"
```
