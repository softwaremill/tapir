...
import sttp.tapir.client.sttp4.streaming.StreamingSttpClientTestsSender
import sttp.tapir.client.tests.ClientStreamingTests

class StreamingSttpClientTests extends StreamingSttpClientTestsSender with ClientStreamingTests[Fs2Streams[IO]] {
