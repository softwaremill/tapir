...
import sttp.tapir.client.tests.{ClientBasicTests, ClientTests}
import sttp.tapir.{DecodeResult, Endpoint}
import zio.Runtime.default
import zio.{CancelableFuture, Task, Unsafe}

abstract class BasicSttpClientZioTestsSender extends ClientTests[Any] with ClientBasicTests { // TODO with ClientBasicTests????
