...
import sttp.client4.{WebSocketStreamBackend, WebSocketStreamRequest}
...
trait WebSocketSttpClientInterpreter extends SttpClientInterpreter { // extends Extensions???
  ...
  /** Interprets the public endpoint as a client call, using the given `baseUri` as the starting point to create the target uri. If
    ...
    */
  def toClient[F[_], I, E, O, R <: WebSockets with Streams[R]](e: PublicEndpoint[I, E, O, R], baseUri: Option[Uri], backend: WebSocketStreamBackend[F, R])(implicit
  ...
  /** Interprets the public endpoint as a client call, using the given `baseUri` as the starting point to create the target uri. If
    ...
    */
  def toClientThrowDecodeFailures[F[_], I, E, O, R <: WebSockets with Streams[R]](
      e: PublicEndpoint[I, E, O, R],
      baseUri: Option[Uri],
      backend: WebSocketStreamBackend[F, R]
  )(implicit
      wsToPipe: WebSocketToPipe[R]
  ): I => F[Either[E, O]] = {
  ...
  /** Interprets the public endpoint as a client call, using the given `baseUri` as the starting point to create the target uri. If
    ...
    */
  def toClientThrowErrors[F[_], I, E, O, R <: WebSockets with Streams[R]](
      e: PublicEndpoint[I, E, O, R],
      baseUri: Option[Uri],
      backend: WebSocketStreamBackend[F, R]
  )(implicit
  ...
  /** Interprets the public endpoint as a client call, using the given `baseUri` as the starting point to create the target uri. If
    ...
    * headers/status code).
    */
  def toRequest[F[_], I, E, O, R <: WebSockets with Streams[R]](e: PublicEndpoint[I, E, O, R], baseUri: Option[Uri])(implicit
      wsToPipe: WebSocketToPipe[R]
  ): I => WebSocketStreamRequest[DecodeResult[Either[E, O]], R] = {
  ...
  /** Interprets the public endpoint as a client call, using the given `baseUri` as the starting point to create the target uri. If
    ...
    */
  def toRequestThrowDecodeFailures[F[_], I, E, O, R <: WebSockets with Streams[R]](e: PublicEndpoint[I, E, O, R], baseUri: Option[Uri])(implicit
      wsToPipe: WebSocketToPipe[R]
  ): I => WebSocketStreamRequest[Either[E, O], R] =
  ...
  /** Interprets the public endpoint as a client call, using the given `baseUri` as the starting point to create the target uri. If
    ...
    */
  def toRequestThrowErrors[F[_], I, E, O, R <: WebSockets with Streams[R]](e: PublicEndpoint[I, E, O, R], baseUri: Option[Uri])(implicit
      wsToPipe: WebSocketToPipe[R]
  ): I => WebSocketStreamRequest[O, R] =
    i =>
  ...
  /** Interprets the secure endpoint as a client call, using the given `baseUri` as the starting point to create the target uri. If
    ...
    */
  def toSecureClient[F[_], A, I, E, O, R <: WebSockets with Streams[R]](e: Endpoint[A, I, E, O, R], baseUri: Option[Uri], backend: WebSocketStreamBackend[F, R])(
  ...
  /** Interprets the secure endpoint as a client call, using the given `baseUri` as the starting point to create the target uri. If
    ...
    */
  def toSecureClientThrowDecodeFailures[F[_], A, I, E, O, R <: WebSockets with Streams[R]](
  ...
  /** Interprets the secure endpoint as a client call, using the given `baseUri` as the starting point to create the target uri. If
    ...
    * instead.
    */
  def toSecureClientThrowErrors[F[_], A, I, E, O, R <: WebSockets with Streams[R]](
      e: Endpoint[A, I, E, O, R],
      baseUri: Option[Uri],
      backend: WebSocketStreamBackend[F, R]
  )(implicit
  ...
  /** Interprets the secure endpoint as a client call, using the given `baseUri` as the starting point to create the target uri. If
    ...
    */
  def toSecureRequest[F[_], A, I, E, O, R <: WebSockets with Streams[R]](e: Endpoint[A, I, E, O, R], baseUri: Option[Uri])(implicit
      wsToPipe: WebSocketToPipe[R]
  ): A => I => WebSocketStreamRequest[DecodeResult[Either[E, O]], R] =
  ...
  /** Interprets the secure endpoint as a client call, using the given `baseUri` as the starting point to create the target uri. If
    ...
    */
  def toSecureRequestThrowDecodeFailures[F[_], A, I, E, O, R <: WebSockets with Streams[R]](e: Endpoint[A, I, E, O, R], baseUri: Option[Uri])(implicit
      wsToPipe: WebSocketToPipe[R]
  ): A => I => WebSocketStreamRequest[Either[E, O], R] =
  ...
  /** Interprets the secure endpoint as a client call, using the given `baseUri` as the starting point to create the target uri. If
    ...
    *   when response parsing fails
    */
  def toSecureRequestThrowErrors[F[_], A, I, E, O, R <: WebSockets with Streams[R]](e: Endpoint[A, I, E, O, R], baseUri: Option[Uri])(implicit
      wsToPipe: WebSocketToPipe[R]
  ): A => I => WebSocketStreamRequest[O, R] =
    a =>
      i =>
        new WebSocketEndpointToSttpClient(wsToPipe)
          .toSttpRequest(e, baseUri)
