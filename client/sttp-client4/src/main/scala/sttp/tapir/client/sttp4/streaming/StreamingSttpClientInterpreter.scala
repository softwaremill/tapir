...
trait StreamingSttpClientInterpreter extends SttpClientInterpreter with StreamingSttpClientInterpreterExtensions { // extends Extensions???
  ...
  def toRequest[I, E, O, S <: Streams[S]](
      e: PublicEndpoint[I, E, O, S],
      baseUri: Option[Uri]
  ): I => StreamRequest[DecodeResult[Either[E, O]], S] = {
  ...
  /** Interprets the public endpoint as a client call, using the given `baseUri` as the starting point to create the target uri. If
    ...
    */
  def toRequestThrowErrors[I, E, O, S <: Streams[S]](e: PublicEndpoint[I, E, O, S], baseUri: Option[Uri]): I => StreamRequest[O, S] =
    i =>
  ...
  def toSecureRequest[A, I, E, O, S <: Streams[S]](
      e: Endpoint[A, I, E, O, S],
      baseUri: Option[Uri]
  ): A => I => StreamRequest[DecodeResult[Either[E, O]], S] =
  ...
  def toSecureRequestThrowDecodeFailures[A, I, E, O, S <: Streams[S]](
      e: Endpoint[A, I, E, O, S],
      baseUri: Option[Uri]
  ): A => I => StreamRequest[Either[E, O], S] =
