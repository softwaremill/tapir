...
trait AsyncAPIInterpreter {
  ...
  def toAsyncAPI[A, I, E, O, S](e: Endpoint[A, I, E, O, S], title: String, version: String): AsyncAPI =
    toAsyncAPI(e, Info(title, version), Nil)
  def toAsyncAPI[A, I, E, O, S](e: Endpoint[A, I, E, O, S], title: String, version: String, servers: Iterable[(String, Server)]): AsyncAPI =
    toAsyncAPI(e, Info(title, version), servers)
  def toAsyncAPI[A, I, E, O, S](e: Endpoint[A, I, E, O, S], info: Info): AsyncAPI =
    toAsyncAPI(e, info, Nil)
  def toAsyncAPI[A, I, E, O, S](e: Endpoint[A, I, E, O, S], info: Info, servers: Iterable[(String, Server)]): AsyncAPI =
    EndpointToAsyncAPIDocs.toAsyncAPI(info, servers, Seq(e), asyncAPIDocsOptions, List.empty)
  def toAsyncAPI[A, I, E, O, S](
  ...
  def toAsyncAPI[U, A, I, E, O, S, F[_]](se: ServerEndpoint[U, A, I, E, O, S, F], title: String, version: String): AsyncAPI =
    toAsyncAPI(se, Info(title, version), Nil)
  def toAsyncAPI[U, A, I, E, O, S, F[_]](
      se: ServerEndpoint[U, A, I, E, O, S, F],
      title: String,
      version: String,
      servers: Iterable[(String, Server)]
  ): AsyncAPI =
    toAsyncAPI(se, Info(title, version), servers)
  def toAsyncAPI[U, A, I, E, O, S, F[_]](se: ServerEndpoint[U, A, I, E, O, S, F], info: Info): AsyncAPI =
  ...
  def serverEndpointsToAsyncAPI[F[_]](ses: Iterable[ServerEndpoint[_, _, _, _, _, _, F]], title: String, version: String): AsyncAPI =
  ...
  def serverEndpointsToAsyncAPI[F[_]](ses: Iterable[ServerEndpoint[_, _, _, _, _, _, F]], info: Info): AsyncAPI =
