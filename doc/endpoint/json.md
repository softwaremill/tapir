...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-circe" % "0.14.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-upickle" % "0.14.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play" % "0.14.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-spray" % "0.14.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-tethys" % "0.14.0"
```
