...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-circe" % "0.15.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-upickle" % "0.15.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play" % "0.15.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-spray" % "0.15.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-tethys" % "0.15.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-jsoniter-scala" % "0.15.4"
```
