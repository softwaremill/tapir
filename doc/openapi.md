...
```scala
"com.softwaremill.tapir" %% "tapir-openapi-docs" % "0.11.6"
"com.softwaremill.tapir" %% "tapir-openapi-circe-yaml" % "0.11.6"
```
...
```scala
"com.softwaremill.tapir" %% "tapir-swagger-ui-akka-http" % "0.11.6"
"com.softwaremill.tapir" %% "tapir-swagger-ui-http4s" % "0.11.6"
"com.softwaremill.tapir" %% "tapir-redoc-http4s" % "0.11.6"
```
