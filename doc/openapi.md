...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-docs" % "0.15.4"
"com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml" % "0.15.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.15.4"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-akka-http" % "0.15.4"
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-http4s" % "0.15.4"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-http4s" % "0.15.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.15.4" exclude("com.typesafe.akka", "akka-stream_2.12")
```
