...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-docs" % "0.12.11"
"com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml" % "0.12.11"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.12.11"
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-http4s" % "0.12.11"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-http4s" % "0.12.11"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.12.11" exclude("com.typesafe.akka", "akka-stream_2.12")
```
