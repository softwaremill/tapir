...
```scala
"com.softwaremill.tapir" %% "tapir-openapi-docs" % "0.11.8"
"com.softwaremill.tapir" %% "tapir-openapi-circe-yaml" % "0.11.8"
```
...
```scala
"com.softwaremill.tapir" %% "tapir-swagger-ui-akka-http" % "0.11.8"
"com.softwaremill.tapir" %% "tapir-swagger-ui-http4s" % "0.11.8"
"com.softwaremill.tapir" %% "tapir-redoc-http4s" % "0.11.8"
```
