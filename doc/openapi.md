...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-docs" % "0.12.19"
"com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml" % "0.12.19"
```
...
* `linkFromChildToParent`: should child schemas contain a backlink to the parent schema using `allOf`, in addition 
  to the parent enumerating all children using `oneOf`. The default is `true`, but e.g. the Redoc visualisation might
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.12.19"
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-http4s" % "0.12.19"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-http4s" % "0.12.19"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.12.19" exclude("com.typesafe.akka", "akka-stream_2.12")
```
