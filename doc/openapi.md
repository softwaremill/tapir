...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-docs" % "0.16.5"
"com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml" % "0.16.5"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.16.5" exclude("com.typesafe.akka", "akka-stream_2.12")
```
