...
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-http4s" % "0.12.12"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-http4s" % "0.12.12"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.12.12" exclude("com.typesafe.akka", "akka-stream_2.12")
```
