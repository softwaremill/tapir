...
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-http4s" % "0.12.15"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-http4s" % "0.12.15"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.12.15" exclude("com.typesafe.akka", "akka-stream_2.12")
```
