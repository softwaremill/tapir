...
```scala
"com.softwaremill.tapir" %% "tapir-openapi-docs" % "0.10.0"
"com.softwaremill.tapir" %% "tapir-openapi-circe-yaml" % "0.10.0"
```
...
```scala
"com.softwaremill.tapir" %% "tapir-swagger-ui-akka-http" % "0.10.0"
"com.softwaremill.tapir" %% "tapir-swagger-ui-http4s" % "0.10.0"
```
