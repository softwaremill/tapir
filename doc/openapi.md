...
```scala
"com.softwaremill.tapir" %% "tapir-openapi-docs" % "0.9.1"
"com.softwaremill.tapir" %% "tapir-openapi-circe-yaml" % "0.9.1"
```
...
```scala
"com.softwaremill.tapir" %% "tapir-swagger-ui-akka-http" % "0.9.1"
"com.softwaremill.tapir" %% "tapir-swagger-ui-http4s" % "0.9.1"
```
