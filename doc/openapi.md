...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.14.5"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-akka-http" % "0.14.5"
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-http4s" % "0.14.5"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-http4s" % "0.14.5"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.14.5" exclude("com.typesafe.akka", "akka-stream_2.12")
```
