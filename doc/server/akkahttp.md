...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.12.14"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.12.14" exclude("com.typesafe.akka", "akka-stream_2.12")
```
