...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.16.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.16.4" exclude("com.typesafe.akka", "akka-stream_2.12")
```
