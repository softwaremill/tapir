...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.12.23"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.12.23" exclude("com.typesafe.akka", "akka-stream_2.12")
```
