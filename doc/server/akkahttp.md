...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.12.6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.12.6" exclude("com.typesafe.akka", "akka-stream_2.12")
```
