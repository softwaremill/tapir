...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.14.5"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.14.5" exclude("com.typesafe.akka", "akka-stream_2.12")
```
