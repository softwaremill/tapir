...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.14.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.14.0" exclude("com.typesafe.akka", "akka-stream_2.12")
```
