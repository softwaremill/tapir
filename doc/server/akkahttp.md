...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.12.28"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.12.28" exclude("com.typesafe.akka", "akka-stream_2.12")
```
