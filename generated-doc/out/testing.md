...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-sttp-stub-server" % "1.0.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-sttp-mock-server" % "1.0.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-testing" % "1.0.2"
```
