...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-sttp-stub-server" % "1.2.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-sttp-mock-server" % "1.2.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-testing" % "1.2.3"
```
