...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-sttp-stub-server" % "1.2.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-sttp-mock-server" % "1.2.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-testing" % "1.2.0"
```
