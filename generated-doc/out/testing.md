...
"com.softwaremill.sttp.tapir" %% "tapir-sttp-stub4-server" % "1.13.27"

// for sttp-client v3
"com.softwaremill.sttp.tapir" %% "tapir-sttp-stub-server" % "1.13.27"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "sttp-mock-server" % "1.13.27"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-testing" % "1.13.27"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-verifier" % "1.13.27"
```
