...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-sttp-stub-server" % "1.10.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "sttp-mock-server" % "1.10.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-testing" % "1.10.4"
```
