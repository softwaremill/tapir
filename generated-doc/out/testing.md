...
"com.softwaremill.sttp.tapir" %% "tapir-sttp-stub4-server" % "1.11.37"

// for sttp-client v3
"com.softwaremill.sttp.tapir" %% "tapir-sttp-stub-server" % "1.11.37"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "sttp-mock-server" % "1.11.37"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-testing" % "1.11.37"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-verifier" % "1.11.37"
```
