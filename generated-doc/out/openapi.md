...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-docs" % "0.16.14"
"com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml" % "0.16.14"
```
...
```scala
// Akka HTTP
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.16.14"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-akka-http" % "0.16.14"

// Finatra
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-finatra" % "0.16.14"

// HTTP4S
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-http4s" % "0.16.14"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-http4s" % "0.16.14"

// Play
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-play" % "0.16.14"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-play" % "0.16.14"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.16.14" exclude("com.typesafe.akka", "akka-stream_2.12")
```
