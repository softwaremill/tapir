...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server" % "1.4.0"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-cats" % "1.4.0"
```
...
```scala
// for zio2:
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-zio" % "1.4.0"
// for zio1:
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-zio1" % "1.4.0"
```
