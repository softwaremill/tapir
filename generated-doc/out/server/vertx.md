...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server" % "1.13.11"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-cats" % "1.13.11"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-zio" % "1.13.11"
```
