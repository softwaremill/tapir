...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server" % "1.5.2"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-cats" % "1.5.2"
```
...
```scala
// for zio2:
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-zio" % "1.5.2"
// for zio1:
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-zio1" % "1.5.2"
```
