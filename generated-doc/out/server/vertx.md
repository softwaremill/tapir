...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server" % "1.5.3"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-cats" % "1.5.3"
```
...
```scala
// for zio2:
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-zio" % "1.5.3"
// for zio1:
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-zio1" % "1.5.3"
```
