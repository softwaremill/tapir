...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server" % "1.10.5"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-cats" % "1.10.5"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-zio" % "1.10.5"
```
