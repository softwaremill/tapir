...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server" % "1.12.6"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-cats" % "1.12.6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-zio" % "1.12.6"
```
