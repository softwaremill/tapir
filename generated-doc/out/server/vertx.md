...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server" % "1.6.4"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-cats" % "1.6.4"
```
...
```scala
// for zio2:
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-zio" % "1.6.4"
// for zio1:
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-zio1" % "1.6.4"
```
