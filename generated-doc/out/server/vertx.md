...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server" % "1.7.5"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-cats" % "1.7.5"
```
...
```scala
// for zio2:
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-zio" % "1.7.5"
// for zio1:
"com.softwaremill.sttp.tapir" %% "tapir-vertx-server-zio1" % "1.7.5"
```
