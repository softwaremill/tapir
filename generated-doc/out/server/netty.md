...
"com.softwaremill.sttp.tapir" %% "tapir-netty-server" % "1.10.13"
...
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-cats" % "1.10.13"

// if you are using zio:
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-zio" % "1.10.13"
```
