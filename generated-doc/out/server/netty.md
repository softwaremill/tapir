...
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-loom" % "1.9.6"

// if you are using cats-effect:
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-cats" % "1.9.6"

// if you are using zio:
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-zio" % "1.9.6"
```
