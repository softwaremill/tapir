...
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-cats" % "1.2.4"

// if you are using zio:
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-zio" % "1.2.4"

// if you are using zio1:
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-zio1" % "1.2.4"
```
