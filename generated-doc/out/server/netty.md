...
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-sync" % "1.12.6"

// if you are using Future:
"com.softwaremill.sttp.tapir" %% "tapir-netty-server" % "1.12.6"

// if you are using cats-effect:
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-cats" % "1.12.6"

// if you are using zio:
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-zio" % "1.12.6"
```
