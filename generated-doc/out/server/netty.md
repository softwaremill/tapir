...
"com.softwaremill.sttp.tapir" %% "tapir-netty-server" % "1.11.32"
...
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-cats" % "1.11.32"

// if you are using zio:
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-zio" % "1.11.32"
```
