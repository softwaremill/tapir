...
"com.softwaremill.sttp.tapir" %% "tapir-netty-server" % "1.13.13"

// if you are using cats-effect:
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-cats" % "1.13.13"

// if you are using zio:
"com.softwaremill.sttp.tapir" %% "tapir-netty-server-zio" % "1.13.13"
```
