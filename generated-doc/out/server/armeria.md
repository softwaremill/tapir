...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server" % "1.0.0-M9"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-cats" % "1.0.0-M9"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-zio" % "1.0.0-M9"
```
