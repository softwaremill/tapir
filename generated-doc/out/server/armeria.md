...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server" % "1.12.2"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-cats" % "1.12.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-zio" % "1.12.2"
```
