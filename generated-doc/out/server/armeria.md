...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server" % "1.9.6"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-cats" % "1.9.6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-zio" % "1.9.6"
```
