...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server" % "0.20.0"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-cats" % "0.20.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-zio" % "0.20.0"
```
