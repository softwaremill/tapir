...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server" % "1.12.4"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-cats" % "1.12.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-zio" % "1.12.4"
```
