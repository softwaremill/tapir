...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server" % "0.20.2"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-cats" % "0.20.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-zio" % "0.20.2"
```
