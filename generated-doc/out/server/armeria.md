...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server" % "1.10.13"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-cats" % "1.10.13"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-zio" % "1.10.13"
```
