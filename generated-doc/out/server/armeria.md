...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server" % "0.20.1"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-cats" % "0.20.1"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-zio" % "0.20.1"
```
