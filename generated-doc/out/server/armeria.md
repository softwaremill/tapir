...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server" % "1.11.43"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-cats" % "1.11.43"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-zio" % "1.11.43"
```
