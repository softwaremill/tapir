...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server" % "1.13.20"
```
...
Add the following dependency
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-cats" % "1.13.20"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-armeria-server-zio" % "1.13.20"
```
