...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.1.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.1.4"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.1.4"
```
