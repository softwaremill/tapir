...
```sbt
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.6.1"
```
...
```sbt
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.6.1"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.6.1"
"com.softwaremill.sttp.tapir" %% "tapir-aws-cdk" % "1.6.1"
```
