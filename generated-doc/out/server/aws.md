...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda-core" % "1.13.25"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.13.25"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda-zio" % "1.13.25"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.13.25"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.13.25"
"com.softwaremill.sttp.tapir" %% "tapir-aws-cdk" % "1.13.25"
```
