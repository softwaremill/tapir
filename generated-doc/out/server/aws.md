...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "0.18.0-M18"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "0.18.0-M18"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "0.18.0-M18"
```
