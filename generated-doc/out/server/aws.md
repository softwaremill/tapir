...
```sbt
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.7.5"
```
...
```sbt
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.7.5"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.7.5"
"com.softwaremill.sttp.tapir" %% "tapir-aws-cdk" % "1.7.5"
```
