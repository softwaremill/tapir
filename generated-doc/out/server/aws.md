...
```sbt
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.9.11"
```
...
```sbt
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.9.11"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.9.11"
"com.softwaremill.sttp.tapir" %% "tapir-aws-cdk" % "1.9.11"
```
