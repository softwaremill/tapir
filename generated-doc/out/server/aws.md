...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "0.20.0-M10"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "0.20.0-M10"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "0.20.0-M10"
```
