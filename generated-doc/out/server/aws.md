...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.2.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.2.0"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.2.0"
```
