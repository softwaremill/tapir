...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.2.6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.2.6"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.2.6"
```
