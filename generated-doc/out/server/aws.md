...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "0.18.1"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "0.18.1"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "0.18.1"
```
