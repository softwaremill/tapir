...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.12.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.12.4"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.12.4"
"com.softwaremill.sttp.tapir" %% "tapir-aws-cdk" % "1.12.4"
```
