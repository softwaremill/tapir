...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.1.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.1.0"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.1.0"
```
