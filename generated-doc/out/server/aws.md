...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "0.19.0-M14"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "0.19.0-M14"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "0.19.0-M14"
```
