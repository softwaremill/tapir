...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "0.19.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "0.19.3"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "0.19.3"
```
