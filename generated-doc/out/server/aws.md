...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.13.7"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.13.7"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.13.7"
"com.softwaremill.sttp.tapir" %% "tapir-aws-cdk" % "1.13.7"
```
