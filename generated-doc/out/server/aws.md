...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "0.19.1"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "0.19.1"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "0.19.1"
```
