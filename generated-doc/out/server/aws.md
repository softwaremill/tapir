...
```sbt
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.10.6"
```
...
```sbt
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.10.6"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.10.6"
"com.softwaremill.sttp.tapir" %% "tapir-aws-cdk" % "1.10.6"
```
