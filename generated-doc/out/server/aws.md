...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.0.0-M2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.0.0-M2"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.0.0-M2"
```
