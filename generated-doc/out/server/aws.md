...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.11.24"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.11.24"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.11.24"
"com.softwaremill.sttp.tapir" %% "tapir-aws-cdk" % "1.11.24"
```
