...
```sbt
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.8.2"
```
...
```sbt
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.8.2"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.8.2"
"com.softwaremill.sttp.tapir" %% "tapir-aws-cdk" % "1.8.2"
```
