...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.11.6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.11.6"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.11.6"
"com.softwaremill.sttp.tapir" %% "tapir-aws-cdk" % "1.11.6"
```
