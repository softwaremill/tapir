...
```sbt
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.2.13"
```
...
```sbt
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.2.13"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.2.13"
"com.softwaremill.sttp.tapir" %% "tapir-aws-cdk" % "1.2.13"
```
