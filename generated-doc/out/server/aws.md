...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-lambda" % "1.0.0-RC1"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-aws-sam" % "1.0.0-RC1"
"com.softwaremill.sttp.tapir" %% "tapir-aws-terraform" % "1.0.0-RC1"
```
