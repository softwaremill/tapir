...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-prometheus-metrics" % "1.10.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-datadog-metrics" % "1.10.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-zio-metrics" % "1.10.3"
```
