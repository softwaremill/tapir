...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-prometheus-metrics" % "1.7.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-opentelemetry-metrics" % "1.7.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-datadog-metrics" % "1.7.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-zio-metrics" % "1.7.4"
```
