...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-prometheus-metrics" % "1.9.9"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-datadog-metrics" % "1.9.9"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-zio-metrics" % "1.9.9"
```
