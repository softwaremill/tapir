...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-prometheus-metrics" % "1.1.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-opentelemetry-metrics" % "1.1.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-datadog-metrics" % "1.1.3"
```
