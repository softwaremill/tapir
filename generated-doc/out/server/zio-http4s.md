...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-zio" % "1.7.4"
```
...
```scala
// for zio 2:
"com.softwaremill.sttp.tapir" %% "tapir-http4s-server-zio" % "1.7.4"
// for zio 1:
"com.softwaremill.sttp.tapir" %% "tapir-http4s-server-zio1" % "1.7.4"
```
