...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-zio" % "1.5.3"
```
...
```scala
// for zio 2:
"com.softwaremill.sttp.tapir" %% "tapir-http4s-server-zio" % "1.5.3"
// for zio 1:
"com.softwaremill.sttp.tapir" %% "tapir-http4s-server-zio1" % "1.5.3"
```
