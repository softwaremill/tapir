...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.45"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.45" exclude("com.typesafe.akka", "akka-stream_2.12")
```
