...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.48"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.48" exclude("com.typesafe.akka", "akka-stream_2.12")
```
