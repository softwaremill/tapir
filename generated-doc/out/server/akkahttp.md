...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.20.0-M2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.20.0-M2" exclude("com.typesafe.akka", "akka-stream_2.12")
```
