...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.10.12"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.10.12" exclude("com.typesafe.akka", "akka-stream_2.12")
```
