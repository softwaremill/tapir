...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.33"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.33" exclude("com.typesafe.akka", "akka-stream_2.12")
```
