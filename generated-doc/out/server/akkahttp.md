...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.17.20"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.17.20" exclude("com.typesafe.akka", "akka-stream_2.12")
```
