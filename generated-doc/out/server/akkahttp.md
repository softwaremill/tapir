...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.9.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.9.3" exclude("com.typesafe.akka", "akka-stream_2.12")
```
