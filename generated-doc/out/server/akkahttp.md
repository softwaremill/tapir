...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.16.16"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.16.16" exclude("com.typesafe.akka", "akka-stream_2.12")
```
