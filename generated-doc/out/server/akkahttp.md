...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.10.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.10.0" exclude("com.typesafe.akka", "akka-stream_2.12")
```
