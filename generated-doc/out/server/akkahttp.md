...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.40"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.40" exclude("com.typesafe.akka", "akka-stream_2.12")
```
