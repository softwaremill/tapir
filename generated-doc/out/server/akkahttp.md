...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.42"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.42" exclude("com.typesafe.akka", "akka-stream_2.12")
```
