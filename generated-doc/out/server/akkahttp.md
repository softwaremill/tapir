...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.0.0-M7"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.0.0-M7" exclude("com.typesafe.akka", "akka-stream_2.12")
```
