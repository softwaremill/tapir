...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.22"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.22" exclude("com.typesafe.akka", "akka-stream_2.12")
```
