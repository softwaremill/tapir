...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.6.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.6.3" exclude("com.typesafe.akka", "akka-stream_2.12")
```
