...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.18.0-M10"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.18.0-M10" exclude("com.typesafe.akka", "akka-stream_2.12")
```
