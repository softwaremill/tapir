...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.18.0-M16"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.18.0-M16" exclude("com.typesafe.akka", "akka-stream_2.12")
```
