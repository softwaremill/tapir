...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.5.5"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.5.5" exclude("com.typesafe.akka", "akka-stream_2.12")
```
