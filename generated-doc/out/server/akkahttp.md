...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.19.0-M6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.19.0-M6" exclude("com.typesafe.akka", "akka-stream_2.12")
```
