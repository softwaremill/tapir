...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.30"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.30" exclude("com.typesafe.akka", "akka-stream_2.12")
```
