...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.17.18"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.17.18" exclude("com.typesafe.akka", "akka-stream_2.12")
```
