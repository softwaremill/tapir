...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.50"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.50" exclude("com.typesafe.akka", "akka-stream_2.12")
```
