...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT" exclude("com.typesafe.akka", "akka-stream_2.12")
```
