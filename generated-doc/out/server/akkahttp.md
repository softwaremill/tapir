...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.6.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.6.4" exclude("com.typesafe.akka", "akka-stream_2.12")
```
