...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.10.7"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.10.7" exclude("com.typesafe.akka", "akka-stream_2.12")
```
