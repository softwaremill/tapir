...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.38"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.38" exclude("com.typesafe.akka", "akka-stream_2.12")
```
