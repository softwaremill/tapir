...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.7"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.7" exclude("com.typesafe.akka", "akka-stream_2.12")
```
