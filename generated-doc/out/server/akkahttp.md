...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.16"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.16" exclude("com.typesafe.akka", "akka-stream_2.12")
```
