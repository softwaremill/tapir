...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.2.13"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.2.13" exclude("com.typesafe.akka", "akka-stream_2.12")
```
