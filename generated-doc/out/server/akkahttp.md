...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.19.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.19.3" exclude("com.typesafe.akka", "akka-stream_2.12")
```
