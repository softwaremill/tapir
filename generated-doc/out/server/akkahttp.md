...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.20"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.20" exclude("com.typesafe.akka", "akka-stream_2.12")
```
