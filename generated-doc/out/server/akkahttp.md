...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.17.4"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.17.4" exclude("com.typesafe.akka", "akka-stream_2.12")
```
