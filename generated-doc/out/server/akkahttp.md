...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.18"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.18" exclude("com.typesafe.akka", "akka-stream_2.12")
```
