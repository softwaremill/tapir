...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.27"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.27" exclude("com.typesafe.akka", "akka-stream_2.12")
```
