...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.49"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.49" exclude("com.typesafe.akka", "akka-stream_2.12")
```
