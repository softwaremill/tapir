...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.12"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.12" exclude("com.typesafe.akka", "akka-stream_2.12")
```
