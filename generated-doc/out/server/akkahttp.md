...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.9"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.9" exclude("com.typesafe.akka", "akka-stream_2.12")
```
