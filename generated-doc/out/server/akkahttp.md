...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.9.8"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.9.8" exclude("com.typesafe.akka", "akka-stream_2.12")
```
