...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.44"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.44" exclude("com.typesafe.akka", "akka-stream_2.12")
```
