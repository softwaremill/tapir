...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.2.11"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.2.11" exclude("com.typesafe.akka", "akka-stream_2.12")
```
