...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.5.1"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.5.1" exclude("com.typesafe.akka", "akka-stream_2.12")
```
