...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.15"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.11.15" exclude("com.typesafe.akka", "akka-stream_2.12")
```
