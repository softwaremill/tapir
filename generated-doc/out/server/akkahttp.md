...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.18.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.18.2" exclude("com.typesafe.akka", "akka-stream_2.12")
```
