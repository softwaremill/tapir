...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.18.1"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "0.18.1" exclude("com.typesafe.akka", "akka-stream_2.12")
```
