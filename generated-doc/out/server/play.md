...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-play29-server" % "1.13.18"
```

and (if you don't already depend on Play)

```scala
"org.playframework" %% "play-akka-http-server" % "2.9.10"
```

or

```scala
"org.playframework" %% "play-netty-server" % "2.9.10"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-play-server" % "1.13.18"
```
