...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-play29-server" % "1.11.45"
```

and (if you don't already depend on Play)

```scala
"org.playframework" %% "play-akka-http-server" % "2.9.9"
```

or

```scala
"org.playframework" %% "play-netty-server" % "2.9.9"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-play-server" % "1.11.45"
```

and (if you don't already depend on Play)

```scala
"org.playframework" %% "play-pekko-http-server" % "3.0.9"
```
