...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.12.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.12.0" exclude("org.apache.pekko", "pekko-stream_2.12")
```
