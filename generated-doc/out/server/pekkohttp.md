...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.11.50"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.11.50" exclude("org.apache.pekko", "pekko-stream_2.12")
```
