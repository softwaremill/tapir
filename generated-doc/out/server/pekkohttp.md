...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.13.32"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.13.32" exclude("org.apache.pekko", "pekko-stream_2.12")
```
