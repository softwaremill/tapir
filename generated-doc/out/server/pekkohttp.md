...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.10.8"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.10.8" exclude("org.apache.pekko", "pekko-stream_2.12")
```
