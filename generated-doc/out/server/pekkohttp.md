...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.13.6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.13.6" exclude("org.apache.pekko", "pekko-stream_2.12")
```
