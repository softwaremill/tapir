...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.7.1"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.7.1" exclude("org.apache.pekko", "pekko-stream_2.12")
```
