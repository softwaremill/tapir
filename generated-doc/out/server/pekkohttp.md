...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.11.43"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.11.43" exclude("org.apache.pekko", "pekko-stream_2.12")
```
