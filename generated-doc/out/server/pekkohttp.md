...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.8.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.8.2" exclude("org.apache.pekko", "pekko-stream_2.12")
```
