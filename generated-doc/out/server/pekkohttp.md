...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.9.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.9.3" exclude("org.apache.pekko", "pekko-stream_2.12")
```
