...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.7.5"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.7.5" exclude("org.apache.pekko", "pekko-stream_2.12")
```
