...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-upickle" % "0.18.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play" % "0.18.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-spray" % "0.18.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-tethys" % "0.18.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-jsoniter-scala" % "0.18.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-json4s" % "0.18.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-zio" % "0.18.0"
```
