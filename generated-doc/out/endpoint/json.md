...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-upickle" % "1.9.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play" % "1.9.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-spray" % "1.9.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-jsoniter-scala" % "1.9.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-json4s" % "1.9.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-zio" % "1.9.2"
```
