...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-circe" % "1.0.0-M8"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-upickle" % "1.0.0-M8"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play" % "1.0.0-M8"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-spray" % "1.0.0-M8"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-tethys" % "1.0.0-M8"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-jsoniter-scala" % "1.0.0-M8"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-json4s" % "1.0.0-M8"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-zio" % "1.0.0-M8"
```
