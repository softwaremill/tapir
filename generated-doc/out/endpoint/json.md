...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-upickle" % "1.11.13"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play" % "1.11.13"
```

For **Play 2.9** use:

```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play29" % "1.11.13"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-spray" % "1.11.13"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-tethys" % "1.11.13"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-jsoniter-scala" % "1.11.13"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-json4s" % "1.11.13"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-zio" % "1.11.13"
```
