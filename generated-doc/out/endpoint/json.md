...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-upickle" % "1.6.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play" % "1.6.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-spray" % "1.6.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-jsoniter-scala" % "1.6.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-json4s" % "1.6.0"
```
