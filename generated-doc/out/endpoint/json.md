...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-circe" % "1.7.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-upickle" % "1.7.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play" % "1.7.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-spray" % "1.7.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-tethys" % "1.7.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-jsoniter-scala" % "1.7.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-json4s" % "1.7.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-zio" % "1.7.0"
```
