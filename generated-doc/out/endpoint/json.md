...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-circe" % "0.19.0-M6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-upickle" % "0.19.0-M6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play" % "0.19.0-M6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-spray" % "0.19.0-M6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-tethys" % "0.19.0-M6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-jsoniter-scala" % "0.19.0-M6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-json4s" % "0.19.0-M6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-zio" % "0.19.0-M6"
```
