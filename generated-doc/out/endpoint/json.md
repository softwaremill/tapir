...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-upickle" % "0.17.11"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play" % "0.17.11"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-spray" % "0.17.11"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-tethys" % "0.17.11"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-jsoniter-scala" % "0.17.11"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json4s" % "0.17.11"
```
