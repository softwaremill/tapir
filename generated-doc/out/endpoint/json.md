...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-upickle" % "1.7.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play" % "1.7.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-spray" % "1.7.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-tethys" % "1.7.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-jsoniter-scala" % "1.7.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-json4s" % "1.7.3"
```
