...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-upickle" % "1.8.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play" % "1.8.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-spray" % "1.8.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-tethys" % "1.8.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-json4s" % "1.8.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-zio" % "1.8.2"
```
