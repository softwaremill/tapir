...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-zio" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"
"com.softwaremill.sttp.tapir" %% "tapir-zio-http4s-server" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"
```
