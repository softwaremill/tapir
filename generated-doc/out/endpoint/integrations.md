...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-refined" % "1.0.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-enumeratum" % "1.0.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-newtype" % "1.0.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-derevo" % "1.0.2"
```
