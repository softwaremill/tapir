...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-cats" % "1.0.0-M3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-refined" % "1.0.0-M3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-enumeratum" % "1.0.0-M3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-newtype" % "1.0.0-M3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-derevo" % "1.0.0-M3"
```
