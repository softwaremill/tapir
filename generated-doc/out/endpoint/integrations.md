...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-cats" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-refined" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-enumeratum" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"
```
