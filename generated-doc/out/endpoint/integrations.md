...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-cats" % "1.9.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-cats-effect" % "1.9.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-enumeratum" % "1.9.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-newtype" % "1.9.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-monix-newtype" % "1.9.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-zio-prelude" % "1.9.0"
```
