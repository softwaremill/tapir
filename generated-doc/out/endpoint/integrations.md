...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-cats" % "1.13.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-cats-effect" % "1.13.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-refined" % "1.13.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-iron" % "1.13.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-enumeratum" % "1.13.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-newtype" % "1.13.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-monix-newtype" % "1.13.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-zio-prelude" % "1.13.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-derevo" % "1.13.2"
```
