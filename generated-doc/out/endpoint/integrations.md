...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-cats" % "0.17.0-M5"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-refined" % "0.17.0-M5"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-enumeratum" % "0.17.0-M5"
```
