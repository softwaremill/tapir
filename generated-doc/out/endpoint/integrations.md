...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-cats" % "0.19.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-refined" % "0.19.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-enumeratum" % "0.19.3"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-newtype" % "0.19.3"
```
