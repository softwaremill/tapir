...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-cats" % "0.19.0-M10"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-refined" % "0.19.0-M10"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-enumeratum" % "0.19.0-M10"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-newtype" % "0.19.0-M10"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-derevo" % "0.19.0-M10"
```
