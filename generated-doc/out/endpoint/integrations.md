...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-cats" % "0.20.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-refined" % "0.20.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-enumeratum" % "0.20.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-newtype" % "0.20.0"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-derevo" % "0.20.0"
```
