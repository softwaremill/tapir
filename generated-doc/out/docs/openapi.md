...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-bundle" % "0.19.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-redoc-bundle" % "0.19.2"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-docs" % "0.19.2"
"com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml" % "0.19.2"
```
...
`tapir-swagger-ui`:
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui" % "0.19.2"
```

or `tapir-redoc`:
```scala
"com.softwaremill.sttp.tapir" %% "tapir-redoc" % "0.19.2"
```
