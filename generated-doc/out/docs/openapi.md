...
```scala
// Akka HTTP
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.18.3"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-akka-http" % "0.18.3"

// Finatra
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-finatra" % "0.18.3"
...
// Play
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-play" % "0.18.3"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-play" % "0.18.3"

// Vert.x
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-vertx" % "0.18.3"
```
