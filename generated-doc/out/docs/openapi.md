...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-docs" % "1.0.0-M1"
"com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml" % "1.0.0-M1"
```
...
`tapir-swagger-ui`:
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui" % "1.0.0-M1"
```

or `tapir-redoc`:
```scala
"com.softwaremill.sttp.tapir" %% "tapir-redoc" % "1.0.0-M1"
```
