...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-docs" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"
"com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"
```
...
```scala
// Akka HTTP
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-akka-http" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"

// Finatra
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-finatra" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"

// HTTP4S
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-http4s" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-http4s" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"

// Play
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-play" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-play" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.17.0-M11+3-910acc2c+20201215-1528-SNAPSHOT" exclude("com.typesafe.akka", "akka-stream_2.12")
```
