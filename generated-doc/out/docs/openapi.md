...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-bundle" % "1.10.1"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-redoc-bundle" % "1.10.1"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-docs" % "1.10.1"
...
`tapir-swagger-ui`:
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui" % "1.10.1"
```

or `tapir-redoc`:
```scala
"com.softwaremill.sttp.tapir" %% "tapir-redoc" % "1.10.1"
```
