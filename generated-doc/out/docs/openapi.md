...
```scala
// Akka HTTP
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.17.6"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-akka-http" % "0.17.6"

// Finatra
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-finatra" % "0.17.6"

// HTTP4S
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-http4s" % "0.17.6"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-http4s" % "0.17.6"

// Play
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-play" % "0.17.6"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-play" % "0.17.6"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.17.6" exclude("com.typesafe.akka", "akka-stream_2.12")
```
