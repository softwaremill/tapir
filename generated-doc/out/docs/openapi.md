...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-redoc-bundle" % "1.13.25"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-scalar-bundle" % "1.13.25"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-docs" % "1.13.25"
...
`tapir-swagger-ui`:
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui" % "1.13.25"
```

or `tapir-redoc`:
```scala
"com.softwaremill.sttp.tapir" %% "tapir-redoc" % "1.13.25"
```
