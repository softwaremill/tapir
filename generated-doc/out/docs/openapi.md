...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-bundle" % "1.11.39"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-redoc-bundle" % "1.11.39"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-docs" % "1.11.39"
...
`tapir-swagger-ui`:
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui" % "1.11.39"
```

or `tapir-redoc`:
```scala
"com.softwaremill.sttp.tapir" %% "tapir-redoc" % "1.11.39"
```
