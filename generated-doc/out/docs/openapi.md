...
```scala
// Akka HTTP
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.17.2"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-akka-http" % "0.17.2"

// Finatra
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-finatra" % "0.17.2"

// HTTP4S
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-http4s" % "0.17.2"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-http4s" % "0.17.2"
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.17.2" exclude("com.typesafe.akka", "akka-stream_2.12")
```
