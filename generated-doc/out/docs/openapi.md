...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-bundle" % "1.11.30"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-redoc-bundle" % "1.11.30"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-openapi-docs" % "1.11.30"
...
`tapir-swagger-ui`:
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui" % "1.11.30"
```

or `tapir-redoc`:
```scala
"com.softwaremill.sttp.tapir" %% "tapir-redoc" % "1.11.30"
```
