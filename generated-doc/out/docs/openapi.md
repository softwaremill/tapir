...
```scala
// Akka HTTP
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.17.12"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-akka-http" % "0.17.12"
...
// Play
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-play" % "0.17.12"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-play" % "0.17.12"

// Vert.x
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-vertx" % "0.17.12"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.17.12" exclude("com.typesafe.akka", "akka-stream_2.12")
```
