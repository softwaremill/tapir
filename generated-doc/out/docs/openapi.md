...
```scala
// Akka HTTP
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.17.16"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-akka-http" % "0.17.16"

// Finatra
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-finatra" % "0.17.16"

// HTTP4S
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-http4s" % "0.17.16"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-http4s" % "0.17.16"

// Play
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-play" % "0.17.16"
"com.softwaremill.sttp.tapir" %% "tapir-redoc-play" % "0.17.16"

// Vert.x
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-vertx" % "0.17.16"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % "0.17.16" exclude("com.typesafe.akka", "akka-stream_2.12")
```
