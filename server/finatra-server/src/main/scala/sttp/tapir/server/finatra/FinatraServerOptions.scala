...
object FinatraServerOptions extends Logging {
  ...
  /** Creates default [[FinatraServerOptions]] with `additionalInterceptors`, sitting between two configurable
  ...
  def customInterceptors(
      ...
      rejectInterceptor: Option[RejectInterceptor[Future, FinatraContent]] = Some(RejectInterceptor.default),
