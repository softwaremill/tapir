...
import sttp.tapir.server.netty.internal.NettyToResponseBodyBase.DefaultChunkSize
...
trait NettyToResponseBodyBase extends ToResponseBody[NettyResponse, NettyStreams] {
...
private[netty] object NettyToResponseBodyBase {
