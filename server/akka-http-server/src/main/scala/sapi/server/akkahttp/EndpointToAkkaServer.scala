...
object EndpointToAkkaServer {
  ...
  def toDirective[T, I <: HList](e: Endpoint[Id, I])(implicit t: Tupler.Aux[I, T]): Directive[T] = {
  ...
  def toRoute[T, I <: HList, F](e: Endpoint[Id, I])(logic: F)(implicit tt: FnToProduct.Aux[F, I => Future[String]]): Route = {
    toDirective1(e) { values =>
      onComplete(tt(logic)(values.asInstanceOf[I])) { x =>
        complete(x)
      }
    }
  }

  private def toDirective1(e: Endpoint[Id, _]): Directive1[HList] = {
