...
/** Generates the generated-doc/out/includes/examples_list.md file, basing on the metadata included in the source of the examples.
  */
object GenerateListOfExamples {
  private val MetadataPattern = """// \{(.+?)}: (.+)""".r
  private val LinkBase = "https://github.com/softwaremill/tapir/tree/master"
  ...
  def apply(log: Logger, rootBasePath: File): Unit = {
    ...
    // writing the result
    val targetPath = rootBasePath.toPath.resolve("generated-doc/out/includes/examples_list.md")
