...
lazy val perfTests: ProjectMatrix = (projectMatrix in file("perf-tests"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.gatling" % "gatling-test-framework" % "3.14.4" % "test" exclude ("com.fasterxml.jackson.core", "jackson-databind"),
...
lazy val openapiCodegenCore: ProjectMatrix = (projectMatrix in file("openapi-codegen/core"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "2.37.11" % Test,
