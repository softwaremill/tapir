...
lazy val perfTests: ProjectMatrix = (projectMatrix in file("perf-tests"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.gatling.highcharts" % "gatling-charts-highcharts" % "3.14.3" % "test" exclude (
...
lazy val openapiCodegenCore: ProjectMatrix = (projectMatrix in file("openapi-codegen/core"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "2.37.1" % Test,
      "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.37.1" % Provided
    )
  )
